#############################################################################
# Makefile for building: Cubik
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  Cubik.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile Cubik.pro
#############################################################################
...
CXXFLAGS      = -m64 -pipe -O2 -std=c++0x -D_REENTRANT -Wall -W -fPIE $(DEFINES)
...
Makefile: Cubik.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/Cubik1.0.0 || mkdir -p .tmp/Cubik1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Cubik1.0.0/ && $(COPY_FILE) --parents Cubik.h cube.h .tmp/Cubik1.0.0/ && $(COPY_FILE) --parents Cubik.cpp cube.cpp main.cpp .tmp/Cubik1.0.0/ && (cd `dirname .tmp/Cubik1.0.0` && $(TAR) Cubik1.0.0.tar Cubik1.0.0 && $(COMPRESS) Cubik1.0.0.tar) && $(MOVE) `dirname .tmp/Cubik1.0.0`/Cubik1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Cubik1.0.0
...
Cubik.o: Cubik.cpp include/QGLViewer/manipulatedCameraFrame.h \
