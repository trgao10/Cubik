...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_qglviewer__Frame_t, stringdata) + ofs \
...
void qglviewer::Frame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Frame::modified)) {
                *result = 0;
            }
        }
        {
            typedef void (Frame::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Frame::interpolated)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject qglviewer::Frame::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_qglviewer__Frame.data,
      qt_meta_data_qglviewer__Frame,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_qglviewer__Frame.stringdata))
