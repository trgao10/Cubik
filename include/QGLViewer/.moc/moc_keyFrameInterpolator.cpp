...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_qglviewer__KeyFrameInterpolator_t, stringdata) + ofs \
...
QT_MOC_LITERAL(14, 167, 22),
QT_MOC_LITERAL(15, 190, 6),
QT_MOC_LITERAL(16, 197, 20),
QT_MOC_LITERAL(17, 218, 4),
QT_MOC_LITERAL(18, 223, 13),
QT_MOC_LITERAL(19, 237, 6),
QT_MOC_LITERAL(20, 244, 18),
QT_MOC_LITERAL(21, 263, 17),
QT_MOC_LITERAL(22, 281, 18),
QT_MOC_LITERAL(23, 300, 19),
QT_MOC_LITERAL(24, 320, 17),
QT_MOC_LITERAL(25, 338, 6),
QT_MOC_LITERAL(26, 345, 16)
    },
    ...
    "interpolateAtTime\0update\0invalidateValues\0"
};
...
void qglviewer::KeyFrameInterpolator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (KeyFrameInterpolator::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KeyFrameInterpolator::interpolated)) {
                *result = 0;
            }
        }
        {
            typedef void (KeyFrameInterpolator::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KeyFrameInterpolator::endReached)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject qglviewer::KeyFrameInterpolator::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_qglviewer__KeyFrameInterpolator.data,
      qt_meta_data_qglviewer__KeyFrameInterpolator,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_qglviewer__KeyFrameInterpolator.stringdata))
