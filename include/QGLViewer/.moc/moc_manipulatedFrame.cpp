...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_qglviewer__ManipulatedFrame_t, stringdata) + ofs \
...
QT_MOC_LITERAL(11, 191, 10),
QT_MOC_LITERAL(12, 202, 18),
QT_MOC_LITERAL(13, 221, 13),
QT_MOC_LITERAL(14, 235, 14),
QT_MOC_LITERAL(15, 250, 12),
QT_MOC_LITERAL(16, 263, 4),
QT_MOC_LITERAL(17, 268, 10),
QT_MOC_LITERAL(18, 279, 18),
QT_MOC_LITERAL(19, 298, 11),
QT_MOC_LITERAL(20, 310, 7)
    },
...
void qglviewer::ManipulatedFrame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ManipulatedFrame::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ManipulatedFrame::manipulated)) {
                *result = 0;
            }
        }
        {
            typedef void (ManipulatedFrame::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ManipulatedFrame::spun)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject qglviewer::ManipulatedFrame::staticMetaObject = {
    { &Frame::staticMetaObject, qt_meta_stringdata_qglviewer__ManipulatedFrame.data,
      qt_meta_data_qglviewer__ManipulatedFrame,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_qglviewer__ManipulatedFrame.stringdata))
